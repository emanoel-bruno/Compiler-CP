...
public abstract class Procedure {
    ...
    public static final int ASSIGNSTMT_PROCEDURE = 0,
                            ...
                            ONE_COMMENT_PROCEDURE = 27,
                            MULTIPLE_COMMENT_PROCEDURE = 28,
                            ONE_COMMENT_ASTERISK_PROCEDURE = 29,
                            MULTIPLE_COMMENT_ASTERISK_PROCEDURE = 30;
    ...
    public void invoke(int procedure, boolean next) throws IOException, LexicalException, SyntaxException {
        ...
        switch (procedure) {
            ...
            case Procedure.COMMENT_PROCEDURE:
                ...
                break;
            case Procedure.ONE_COMMENT_PROCEDURE:
                new OneCommentProcedure().check(t);
                break;
            case Procedure.MULTIPLE_COMMENT_PROCEDURE:
                new MultipleCommentProcedure().check(t);
                break;
            case Procedure.ONE_COMMENT_ASTERISK_PROCEDURE:
                new OneCommentAsteriskProcedure().check(t);
                break;
            case Procedure.MULTIPLE_COMMENT_ASTERISK_PROCEDURE:
                new MultipleCommentAsteriskProcedure().check(t);
                break;
        }
    }
